...
//g++ -mssse3 -O2 main.cpp train.cpp guessing.cpp md5.cpp -o test.exe
//g++ -mssse3 -O2 -std=c++17 train.cpp guessing.cpp md5.cpp -o md5

//C:\Users\LENOVO\Desktop\PCFG_frameworkSSN\gdb.exe
//C:\Users\LENOVO\Desktop\PCFG_frameworkSSN
int main()
{
    ...
    while (!q.priority.empty())
    {
        ...
        if (q.total_guesses - curr_num >= 100000)
        {
            ...
            if (history + q.total_guesses > 10000000)
            {
                ...
                cout << "Guess time:" << time_guess - time_hash1  << "seconds" << endl;
